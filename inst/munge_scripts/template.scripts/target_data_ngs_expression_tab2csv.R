#
#   Merge all RNASeq data into one table for google cloud storage.
#   
#
#

#   1.  AML RNAseq samples 
#   ====================================================================
rm(list=ls(all=TRUE))
...
#   2.  CCSK RNAseq samples
#   ====================================================================
rm(list=ls(all=TRUE))

setwd(paste0("/data/CCRBioinfo/Henry/BigQuery.Data/target_ccsk/", 
        "target_ccsk_rnaseq_expression"))




#   3.  NBL RNAseq samples
#   ====================================================================
